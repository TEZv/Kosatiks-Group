...
const UI = {
  ua: {
    ...
    riddleCloser: (hint) => `Ближче. ${hint || "Спробуй інакше."}`,
    riddleSolveCount: (n) => `${n} людей розв'язали`,
    riddleSolveCountFirst: "Стань першим, хто розв'язав",
    // Completion modal: shown when all 3 riddles in the weekly level are solved
    riddleCompletionTitle: (n) => `Відлуння ${n} — пройдено`,
    riddleCompletionSubtitle: (week) => `Тиждень ${week} · Anteros · канон`,
    riddleCompletionBody: "Ти розв'язав(-ла) усі три відлуння цього тижня. Тут коло замикається — далі починається нове.",
    riddleDownload: "Завантажити зображення",
    riddleDownloading: "Готую зображення…",
    riddleDownloaded: "Збережено ✓",
    riddleDownloadFailed: "Не вдалось згенерувати. Спробуй ще раз.",
    riddleReplay: "Зіграти ще раз",
    crystalBallLabel: "Кришталева куля",
    crystalBallTooltip: "Торкнись, щоб почути пророцтво",
    crystalBallShake: "Слухаю…",
    dailyWhisperLabel: "Шепіт дня",
    ...
    authorLabel: "Автор?",
    authorSignIn: "Увійти з Google",
    authorSigningIn: "Перевіряю…",
    authorOk: "✓ Автор · колесо відкрито",
    authorNotAuthor: "Ні-ні, ви не автор ANTEROS — я вас вирахувала.",
    authorNeedSignIn: "Колесо лише для автора — натисни Автор? знизу зліва.",
    authorLogout: "Вийти",
  },
  en: {
    ...
    riddleCloser: (hint) => `Closer. ${hint || "Try again, differently."}`,
    riddleSolveCount: (n) => `${n} people solved this`,
    riddleSolveCountFirst: "Be the first to solve this",
    // Completion modal: shown when all 3 riddles in the weekly level are solved
    riddleCompletionTitle: (n) => `Echo ${n} — completed`,
    riddleCompletionSubtitle: (week) => `Week ${week} · Anteros · canon`,
    riddleCompletionBody: "You have solved all three echoes of this week. The circle closes here — a new one begins.",
    riddleDownload: "Download image",
    riddleDownloading: "Preparing image…",
    riddleDownloaded: "Saved ✓",
    riddleDownloadFailed: "Couldn't generate. Try again.",
    riddleReplay: "Play again",
    crystalBallLabel: "Crystal ball",
    crystalBallTooltip: "Touch to hear a prophecy",
    crystalBallShake: "Listening…",
    dailyWhisperLabel: "Daily whisper",
    ...
    authorLabel: "Author?",
    authorSignIn: "Sign in with Google",
    authorSigningIn: "Checking…",
    authorOk: "✓ Author · wheel unlocked",
    authorNotAuthor: "Nope, you're not the ANTEROS author — caught you.",
